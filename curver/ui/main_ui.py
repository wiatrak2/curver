...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.addPointBox.setGeometry(QtCore.QRect(30, 130, 131, 301))
        ...
        self.setCurveType = QtWidgets.QComboBox(self.addPointBox)
        self.setCurveType.setGeometry(QtCore.QRect(20, 10, 104, 26))
