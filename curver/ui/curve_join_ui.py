...
class Ui_curveEditWindow(object):
    def setupUi(self, curveEditWindow):
        ...
        self.splitCurveButton.setGeometry(QtCore.QRect(30, 440, 140, 30))
        ...
        self.smoothJoinC1Button = QtWidgets.QPushButton(curveEditWindow)
        self.smoothJoinC1Button.setGeometry(QtCore.QRect(30, 380, 140, 30))
        self.smoothJoinC1Button.setObjectName("smoothJoinC1Button")
        self.smoothJoinG1Button = QtWidgets.QPushButton(curveEditWindow)
        self.smoothJoinG1Button.setGeometry(QtCore.QRect(30, 410, 140, 30))
        self.smoothJoinG1Button.setObjectName("smoothJoinG1Button")
    ...
    def retranslateUi(self, curveEditWindow):
        ...
        self.smoothJoinC1Button.setText(_translate("curveEditWindow", "Smooth join C1"))
        self.smoothJoinG1Button.setText(_translate("curveEditWindow", "Smooth join G1"))
