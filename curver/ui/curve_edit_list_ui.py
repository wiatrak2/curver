...
class Ui_curveEditWindow(object):
    def setupUi(self, curveEditWindow):
        ...
        curveEditWindow.resize(200, 620)
        ...
        self.changePointsVisibilityButton.setGeometry(QtCore.QRect(30, 310, 140, 32))
    ...
    def retranslateUi(self, curveEditWindow):
        ...
        self.changePointsVisibilityButton.setText(_translate("curveEditWindow", "Show/Hide Points"))
